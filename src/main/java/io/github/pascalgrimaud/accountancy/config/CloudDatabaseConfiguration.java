package io.github.pascalgrimaud.accountancy.config;
...
@Configuration
@EnableMongoRepositories("io.github.pascalgrimaud.accountancy.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("io.github.pascalgrimaud.accountancy.config.dbmigrations");
